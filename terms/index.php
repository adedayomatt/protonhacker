...
<html>
	<head>
	<meta name="description" content="The Best Hacking Service Site For You. Read our terms of service">
	<meta name="keywords" content="protonhacker,terms of service,hacking terms of service">
			...
			<div class="row">
				<div "col-lg-12 col-md-12 col-sm-12 col-xs-12">
					...
					<ol>
						...
						<a href="../request/?category=services&hack=new" class="btn btn-lg btn-default" style="background-color: rgba(0,0,100,1); color: #fff; text-transform: uppercase">REQUEST A SERVICE NOW</a>
					
					<!--Temporary
						<div class="text-center">
							<h1>Terms of Service</h1> 
							<img src="../resources/images/others/locker.gif" width="200px" height="200px" class="service-image">
							<p>We are currently reviewing our Terms of Service, this is to serve you better.</p>
							<p>Meanwhile you can easily reach us via <a href="mailto: hackers@protonhackers.com">hackers@protonhackers.com</a></p>
						</div>
						Temporary-->
